...
net_arg.add_argument(
    "--net_channels", type=int, default=384, help=""
...
data_arg.add_argument(
    "--data_tr", type=str, default='/data/wangyang/data_dump/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='/data/wangyang/data_dump/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='/data/wangyang/data_dump/yfcc-sift-2000-test.hdf5', help=""
