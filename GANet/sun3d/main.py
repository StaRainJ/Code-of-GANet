...
def main(config):
    ...
    if config.run_mode == "train":
        ...
        test_dataset = CorrespondencesDataset(config.data_te, config) # input data-- data.CorrespondencesDataset
        print('Set test_dataset!!')
        print(test_dataset)
        ...
        test(test_loader, model, config) # run test -- test.test # multiple workors for batch data
