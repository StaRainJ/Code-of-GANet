...
from sinkhorn_norm import SparseAttention
import scipy
...
class Group_Attention(nn.Module):
    def __init__(self, inchannel, outchannel, weight_out= False):
        ...
        self.sattn = SparseAttention(blocks=40, temperature= (inchannel ** .5), sinkhorn_iter=8)
...
class ATEM(nn.Module):
    def __init__(self, net_channels=128, input_channel=4, ):
    ...
    def forward(self, x):
        ...
        l = {}
        l['S'] = S[0].detach().cpu().numpy()
        scipy.io.savemat('S.mat',l)
